...
public class SafeInput {
    ...
    public static void main(String[] args)  {
        ...
        getString(myObj, "Enter a string : ");

        getArrayOfStrings(myObj, "Enter a string : ");
    ...
    public static ArrayList<String> getArrayOfStrings(Scanner console, String prompt) {
        ...
        char readNextString = 'Y';
        while (readNextString == 'Y')
        {
            System.out.println(prompt);
            String answer = console.nextLine();
            retval.add (answer);
            System.out.print(" Enter More? (Y/N) \n" );
            String shouldIContinue = console.nextLine();
            readNextString = shouldIContinue.charAt(0);
        }
        return retval;
    }
